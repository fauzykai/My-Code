...
//----------Loop Settings----------
#define LOOP_PIN A6
#define LOOP_DETECT_TRESHOLD 200 // kofigurasi nilai detect minimum adc
#define LOOP_OUTPUT_VALUE 14// jika ada objek, akan dikirimkan nilai ini, seolah2 nilai jarak
//----------LED Settings----------
#define LAMP_NUM 5
...
void setup() {
  ...
  Serial.println("BRD V1 FW V4.2");
  //pinMode(BUZZ, OUTPUT);
  for (int i = 0 ; i < LAMP_NUM; i++)
  {
    pinMode(Led[i], OUTPUT);
  }
  pinMode(LOOP_PIN, INPUT);
}
