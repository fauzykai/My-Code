...
//----------ESP Settings-----------
#define ESP_SSID "FAUZY-MD-S24G" // SSID wifi yang akan diakses
#define ESP_PWD "rahasialabplc11" // Password wifi yang akan diakses
#define ESP_PORT 80 // port web yang akan dipakai


//----------Soft Serial Settings----------
#include <SoftwareSerial.h> // Lib Serial untuk berkomunikasi dengan ESP
SoftwareSerial mySerial(2, 3); // Deklarasi pin serial ESP
//----------LCD Settings----------
...
void setup() {
  ...
  mySerial.begin(S_BAUD); // baud rate yang dipakai untuk komunikasi dgn esp
